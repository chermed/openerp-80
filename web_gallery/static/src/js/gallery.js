...
var _t = instance.web._t,
    ...
    instance.web.Sidebar = instance.web.Sidebar.extend({
        ...
        on_click_show_gallery: function() {
            ...
            Attachments.query(['name','datas_fname','file_type','datas','datas']).filter([['res_model', '=', this.dataset.model],['res_id', '=', this.dataset.ids[this.dataset.index]]]).all().then(function (pieces) {
			    _.each(pieces, function(piece){ 
			         if ((/\.(gif|jpg|jpeg|tiff|png|bmp)$/i).test(piece['datas_fname'])){
                         element = [piece['name'],piece['datas_fname'],piece['file_type'],piece['datas']];
